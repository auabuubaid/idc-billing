          ...
          <div class="card">
            <div class="card-header">
              <h3 class="col-md-12 card-title">
                <form role="form" action="{{route('cabletv-advance-payment')}}" method="get" id="advance-payment-form">
                  <div class="row">
                    <div class="col-md-2">
            ...
            <div class="card-body table-responsive p-2">
              ...
              <div class="float-right">{{ $advancePaymentArr->withQueryString()->links() }}</div>
            </div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
