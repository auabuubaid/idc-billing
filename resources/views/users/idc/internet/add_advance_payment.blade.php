...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Internet Advance Payment</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{route('internet-subscribers')}}">Internet</a></li>
            <li class="breadcrumb-item"><a href="{{route('internet-advance-payment')}}">Advance Payment</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <form role="form" action="{{route('store-internet-advance-payment')}}" method="post">
              @csrf
              <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input name="customer_name" type="text" class="form-control" id="SelectCustomerName" readonly placeholder="Customer name" value="{{ customerNameByID($ihistoryArr->customer_id) }}">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="InputCustomerAddress">Customer Address</label>
                        <input name="customer_address" type="text" class="form-control" id="InputCustomerAddress" readonly placeholder="Customer address" value="{{ unitAddressByUnitID($ihistoryArr->address_id) }}">
                      </div>
                    </div>                
                  </div>
                </fieldset>                  
                    ...
                    <div class="col-md-1">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input name="monthly_fee" type="text" readonly class="form-control" id="InputMonthlyFee" value="{{ amountFormat2($ihistoryArr->monthly_fee) }}">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-2">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="InputRemark">Remark</label>
                        ...
                        <input name="customer_id" type="hidden" value="{{ $ihistoryArr->customer_id }}">
                        <input name="address_id" type="hidden" value="{{ $ihistoryArr->address_id }}">
              ...
              <div class="card-footer">
                <a href="{{ route('internet-advance-payment') }}" class="btn btn-warning"> <i class="fas fa-backward"></i> Back</a>
                <a href="{{ route('add-internet-advance-payment',['id'=>$ihistoryArr->customer_id]) }}" class="btn btn-info"> <i class="fas fa-redo-alt"></i> Refresh</a>
...
$( document ).ready(function() {
  ...
  $('#InputFromDate').change(function(){
    ...
    var period= $('#InputPeriod').val();
    var endDate= moment(startDate,"DD-MM-YYYY").add((period-1), 'month').endOf('month').format("25-MM-YYYY");
...
{  
  ...
  var endDate = moment(startDate,"DD-MM-YYYY").add((period-1), 'month').endOf('month').format("25-MM-YYYY");
  $('#InputEndDate').val(endDate);
  totalFee = (parseFloat(monthlyFee*period)).toFixed(2);
