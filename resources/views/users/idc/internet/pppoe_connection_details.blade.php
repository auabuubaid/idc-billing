        ...
        <div class="container" id="container">            
            <div class="form-container sign-in-container">
                <form action="#">
                    ...
                    <h2 class="white">Internet Connection Details</h2>
                    ...
                    <div style="margin-top: 15px;">
                        <p class="white" style="font-size: 15px;">For more details call at 023-871-200, 012-999-060, 015-505-501</p>
                    </div>
                    <p class="white" style="margin: 15px; font-size: 13px;">Social Connect</p>
