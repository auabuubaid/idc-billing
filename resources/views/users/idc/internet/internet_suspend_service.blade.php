          ...
          <div class="card card-primary card-outline">
            <div class="card-body">
              <ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link active" id="custom-content-above-suspension-tab" data-toggle="pill" href="#custom-content-above-suspension" role="tab" aria-controls="custom-content-above-suspension" aria-selected="false"><i class="fas fa-power-off"></i> Suspension</a>
                </li>
                <li class="nav-item">
              ...
              <div class="tab-content" id="custom-content-above-tabContent">
                <div class="tab-pane fade show active" id="custom-content-above-suspension" role="tabpanel" aria-labelledby="custom-content-above-settings-tab">
                  <form role="form" action="{{route('update-internet-suspension')}}" method="post" onsubmit="return matchSuspendDate()">
                    @csrf
                    <div class="card-body">
                      ...
                      <fieldset style="border: 1px solid #ced4da; padding:0px 15px;">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="InputSuspensionStartDate">Start Date<span class="text-danger">*</span></label>
                                <div class="input-group">
                                  <div class="input-group">
                                    <div class="input-group-prepend">
                                      <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                    </div>
                                    <input type="text" name="suspension_start" id="InputSuspensionStartDate" value="{{ old('suspension_start') }}" class="form-control pull-right datePicker">
                                  </div>
                                </div>
                              @error('suspension_start')<span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                          </div> 
                          <div class="col-md-3">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <label for="InputDueAmount">Due Amount<span class="text-danger">*</span></label>
                                <div class="input-group">
                                  ...
                                  <input name="due_amount" type="text" class="form-control fee" id="InputDueAmount" placeholder="Enter due amount" value="{{ old('due_amount') }}">
                                </div>
                    ...
                    <div class="card-footer">
                      ...
                      <a href="{{route('internet-suspend-service')}}" class="btn btn-info"> <i class="fas fa-redo-alt"></i> Refresh</a>
...
function getCustomerDetails(custID)
{
  ...
  $.ajax({
    url: '{{ route("get-customer-with-suspend-details") }}',
    type: 'post',
    data: { "_token":"{{ csrf_token() }}" , "custID": custID , "suspendDateTime": date+' '+time },
    dataType: 'json',
