        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Import Buildings Location</h3>
            </div>
            <!-- /.card-header -->
            <form role="form" action="{{ route('store-import-buildings-location') }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <label for="Help"><span class="text-danger"><i class="fas fa-info-circle"></i></span></label>
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
              <div class="card-footer">
                ...
                <a href="{{ route('import-buildings-location') }}" class="btn btn-info"> <i class="fas fa-redo-alt"></i> Refresh</a>
