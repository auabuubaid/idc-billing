        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Add CableTV Plan</h3>
            </div>
            <!-- /.card-header -->
            <form role="form" action="{{route('store-cabletv-service')}}" method="post">
              @csrf
              <div class="card-body">
                <div class="row">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input name="new_tv_fee" type="text" class="form-control" id="InputPerTVFee" placeholder="Enter new tv fee" value="{{ old('new_tv_fee')}}">
                      </div>
              ...
              <div class="card-footer">
                ...
                <a href="{{route('add-cabletv-service')}}" class="btn btn-info"> <i class="fas fa-redo-alt"></i> Refresh</a>
